        ...
        {showTangkahan && (
          <div className={`w-[80%] flex flex-col items-center justify-center px-6 sm:px-10 lg:px-16 transition-all duration-1000 ease-in-out ${tangkahanOut ? 'opacity-0 -translate-y-4' : (tangkahanIn ? 'opacity-100 translate-y-20' : 'opacity-0 translate-y-32')}`} style={{ height: 'auto', minHeight: '350px' }}>
            ...
            <div className="flex flex-col items-center w-full max-w-md mt-10 pointer-events-auto">
              ...
              <span className="font-sans text-[0.65rem] text-[rgba(255,255,255,0.6)] -mt-28 md:-mt-32 text-center max-w-[80%] leading-relaxed tracking-wide relative z-10">
        ...
        <div className="w-[70%] md:w-3/4 h-full relative z-10 pointer-events-none">
          ...
          >
            <div className="flex items-center gap-6">
              <GlitchText speed={3.5} enableShadows enableOnHover={false} className="text-tangkahan-gold font-serif italic text-[12rem] md:text-[18rem] leading-none mx-0">
                5
              </GlitchText>
  ...
  return (
    <footer className="relative bg-[#020503] w-full min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div ref={ref} className="rv mx-auto text-center relative z-10 flex flex-col items-center px-4 mt-12" style={{ maxWidth: '850px' }}>
        <h2 className="font-display italic text-[#e2e8f0] leading-[1.15] mb-4 text-center select-none" style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', textShadow: '0 10px 30px rgba(0,0,0,0.8), 0 2px 4px rgba(255,255,255,0.15)' }}>
          Why all of this
          <br />
          imp<span className="relative inline-block">o<span className="absolute -inset-1 border border-[#4ade80] rounded-full scale-110 pointer-events-none shadow-[0_0_10px_rgba(74,222,128,0.6)] animate-pulse"></span></span>rtant?
        </h2>
        <p className="mt-4 mb-10 text-[0.85rem] sm:text-[0.95rem] text-[#86a890] max-w-2xl mx-auto leading-relaxed font-sans text-center">
          To protect a destination, you must first empower its people. When local communities thrive through responsible tourism, environmental preservation shifts from a financial burden to their most valuable asset. We bridge the gap between conscious travelers and local entrepreneurs, ensuring your visit actively funds the long-term survival of both the ecosystem and the economy.
        </p>
        <button 
          type="button" 
...
function ForestAtlas() {
  return (
    <section id="atlas" className="relative w-full h-screen bg-[#020807] overflow-hidden">
      ...
      <DomeGallery 
        images={[
          { src: '/asset/tangkahanATLAS/[atlas]01.jpg', alt: 'Atlas 1' },
          { src: '/asset/tangkahanATLAS/[atlas]02.jpeg', alt: 'Atlas 2' },
          { src: '/asset/tangkahanATLAS/[atlas]03.jpeg', alt: 'Atlas 3' },
          { src: '/asset/tangkahanATLAS/[atlas]04.jpg', alt: 'Atlas 4' },
          { src: '/asset/tangkahanATLAS/[atlas]05.jpeg', alt: 'Atlas 5' },
          { src: '/asset/tangkahanATLAS/[atlas]06.jpeg', alt: 'Atlas 6' },
          { src: '/asset/tangkahanATLAS/[atlas]07.webp', alt: 'Atlas 7' },
          { src: '/asset/tangkahanATLAS/[atlas]08.jpeg', alt: 'Atlas 8' },
          { src: '/asset/tangkahanATLAS/[atlas]09.jpeg', alt: 'Atlas 9' },
          { src: '/asset/tangkahanATLAS/[atlas]10.jpeg', alt: 'Atlas 10' },
          { src: '/asset/tangkahanATLAS/[atlas]11.jpeg', alt: 'Atlas 11' },
          { src: '/asset/tangkahanATLAS/[atlas]12.jpg', alt: 'Atlas 12' },
          { src: '/asset/tangkahanATLAS/[atlas]13.jpeg', alt: 'Atlas 13' },
          { src: '/asset/tangkahanATLAS/[atlas]14.jpeg', alt: 'Atlas 14' },
          { src: '/asset/tangkahanATLAS/[atlas]15.webp', alt: 'Atlas 15' },
          { src: '/asset/tangkahanATLAS/[atlas]16.jpeg', alt: 'Atlas 16' },
          { src: '/asset/tangkahanATLAS/[atlas]17.jpg', alt: 'Atlas 17' },
          { src: '/asset/tangkahanATLAS/[atlas]18.jpeg', alt: 'Atlas 18' },
          { src: '/asset/tangkahanATLAS/[atlas]19.jpeg', alt: 'Atlas 19' },
          { src: '/asset/tangkahanATLAS/[atlas]20.jpeg', alt: 'Atlas 20' },
          { src: '/asset/tangkahanATLAS/[atlas]21.jpeg', alt: 'Atlas 21' },
          { src: '/asset/tangkahanATLAS/[atlas]22.jpeg', alt: 'Atlas 22' },
          { src: '/asset/tangkahanATLAS/[atlas]23.jpeg', alt: 'Atlas 23' },
          { src: '/asset/tangkahanATLAS/[atlas]24.jpeg', alt: 'Atlas 24' },
          { src: '/asset/tangkahanATLAS/[atlas]25.jpeg', alt: 'Atlas 25' }
        ]}
...
function VisitorInfo() {
  ...
  const infoData = [
    ...
    { category: "FAQ", title: "Where to stay?", desc: "Accommodation here is all about rustic, riverside charm. Popular spots like Mega Inn, Tangkahan Jungle Lodge, and Green Lodge offer cozy wooden bungalows built right along the riverbank.", link: "https://share.google/8weIKUv62cXydJGPX", linkText: "BOOK NOW", color: "#f59e0b", img: "/asset/Where-to-stay.jpeg" },
